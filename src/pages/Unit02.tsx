...
import { ArrowLeft, Play, Users, ChevronRight, Clock, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#020202] pt-32 selection:bg-emerald-500/30 selection:text-white font-body">
      ...
      <div className="container px-4 mx-auto max-w-5xl relative z-10">
        ...
        <StationHeader 
          unitNumber="UNIT_02" 
          unitTitle="H and Ms // Children's Fantasy" 
        ...
        <div className="flex flex-col items-center mb-32 relative">
           ...
           >
              <img 
                 ...
                 alt="H and M Official Poster Exhibition"
                 onError={(e) => { 
                   e.currentTarget.style.display = 'none'; 
                   e.currentTarget.parentElement?.classList.add('bg-zinc-900', 'flex', 'items-center', 'justify-center'); 
                 }}
              />
           ...
           <div className="relative z-20 -mt-14">
             <button 
               ...
               className={`group flex items-center gap-3 px-8 py-4 rounded-full font-mono text-[10px] uppercase tracking-[0.4em] font-black transition-all border ${showColor ? 'bg-emerald-500 text-black border-emerald-500' : 'bg-[#050505] text-white/50 border-white/10'}`}
             >
            ...
            <div className="space-y-8 max-w-3xl">
              <div className="flex gap-6 group text-left">
                ...
                <div className="pb-8">
                  ...
                  <p className="text-zinc-500 leading-relaxed font-serif italic text-base">
                    Core narrative blocks and primary world-building established. These episodes define the visual language of the universe.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 group text-left">
                ...
                <div className="pb-8">
                  ...
                  <p className="text-zinc-500 leading-relaxed font-serif italic text-base">
                    Utilizing the refined tech-blend for visual effects, color grading, and final sound engineering.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 group text-left">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 leading-relaxed font-serif italic text-base">
                    Active scripting, talent casting, and cinematic location scouting.
                  </p>
                </div>
              </div>
            </div>
           ...
           <div className="w-full md:w-[70%] lg:w-[60%] bg-[#050505] border border-white/5 hover:border-emerald-500/30 transition-colors p-8 relative overflow-hidden group rounded-2xl cursor-pointer" onClick={() => setShowApprentice(!showApprentice)}>
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                 ...
                 <div className="flex items-center gap-2">
                    <span className="font-mono text-[9px] text-zinc-500 tracking-widest uppercase">{showApprentice ? 'Close' : 'Secure'}</span>
                    <div className={`w-2 h-2 rounded-full ${showApprentice ? 'bg-emerald-500 animate-pulse' : 'bg-zinc-700'}`} />
                 </div>
              </div>
