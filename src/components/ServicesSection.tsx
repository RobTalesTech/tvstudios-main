...
const ServicesSection = () => {
  ...
  const handleIntakeSubmit = (
    ...
    const emailSubject = `Project Sync Intake: ${serviceName}`;
    const emailBody = `Project Intake Details\n---------------------\nService: ${serviceName}\nClient Email: ${email}\n\nProject Brief/Intake Details:\n${details}\n\n${additionalData}\n---------------------\nSubmitted via TV³ Studios Intake Gateway.`;
